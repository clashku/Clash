...
- **下载地址**：[GitHub备份](https://github.com/clashku/Clash-for-Windows)
- **使用教程**：[https://clashku.com/clash-for-windows/](https://clashku.com/clash-for-windows/)
- **支持平台**：Windows、macOS、Linux

### :pushpin: ClashX
- **下载地址**：[GitHub备份](https://github.com/clashku/ClashX)
- **使用教程**：[https://clashku.com/clashx/](https://clashku.com/clashx/)
- **支持平台**：macOS

### :pushpin: Clash for Android
- **下载地址**：[GitHub备份](https://github.com/clashku/Clash-for-Android])
- **使用教程**：[https://clashku.com/clash-for-android/](https://clashku.com/clash-for-android/)
- **支持平台**：Android
...
- **优惠购买**：[优惠购买链接](https://clashku-github.affout.com/erwan/)
...
- [Clash Releases](https://clashku.com/clashreleases/)
...
|------------------------|------|---------|-------|-------|-----|---------|----|----|
| [Clash for Android](https://clashforandroid.org/)      | :red_circle:    | :x:       | :x:     | :x:     | :x:   | :white_check_mark:       | [备份](https://github.com/clashku/Clash-for-Android) | [教程](https://clashforandroid.org/) |
| [Clash for Windows](https://clashforwindows.org/)      | :red_circle:    | :white_check_mark:       | :white_check_mark:     | :white_check_mark:     | :x:   | :x:       | [备份](https://github.com/clashku/Clash-for-Windows) | [教程](https://clashforwindows.org/) |
...
| [ClashX](https://clashx.org/)                 | :red_circle:    | :x:       | :white_check_mark:     | :x:     | :x:   | :x:       | [备份](https://github.com/clashku/ClashX) | [教程](https://clashx.org/) |
